...
class SingleProp(
    ...
    eval_single_prop_ref: List[EvalSinglePropRef] = element(
        ...
        tag="EvalSinglePropRef",
        json_schema_extra=dict(multiple=True, xml="EvalSinglePropRef"),
    )
    ...
    def add_to_eval_single_prop_ref(
        ...
        **kwargs
        ...
        """
        This method adds an object of type 'EvalSinglePropRef' to attribute eval_single_prop_ref
        ...
        if id is not None:
            params["id"] = id
        self.eval_single_prop_ref.append(EvalSinglePropRef(**params))
