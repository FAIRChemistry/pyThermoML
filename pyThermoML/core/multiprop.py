...
class MultiProp(
    ...
    eval_multi_prop_ref: List[EvalMultiPropRef] = element(
        ...
        tag="EvalMultiPropRef",
        json_schema_extra=dict(multiple=True, xml="EvalMultiPropRef"),
    )
    s_eval_multi_prop_description: Optional[str] = element(
        default=None,
        tag="sEvalMultiPropDescription",
        json_schema_extra=dict(xml="sEvalMultiPropDescription"),
    )
    ...
    def add_to_eval_multi_prop_ref(
        ...
        **kwargs
        ...
        """
        This method adds an object of type 'EvalMultiPropRef' to attribute eval_multi_prop_ref
        ...
        if id is not None:
            params["id"] = id
        self.eval_multi_prop_ref.append(EvalMultiPropRef(**params))
